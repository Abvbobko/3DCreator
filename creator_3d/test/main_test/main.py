...
import cv2
import math
from creator_3d.test.main_test import const
import numpy as np
...
def get_matched_colors(c1, c2, matches):
    """Can be merged with get_matched_points"""
...
# bundle adjustment
########################
# In this part, the function get_3dpos is the correction of some points in the original method,
# and get_3dpos2 is the correction according to the needs of the author,
# i.e. all points that should initially be corrected are removed.
...
# There are two ways to map, one of which is done by matplotlib,
# but the second is done based on mayavi,
# the effect is better, fig_v1 works better.fig_v2 is the effect of mayavi plus color
